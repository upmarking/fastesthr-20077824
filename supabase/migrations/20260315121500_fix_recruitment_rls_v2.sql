-- =============================================
-- FIX: Comprehensive RLS policy rewrite for Recruitment
-- The previous FOR ALL + is_company_admin() policies block
-- INSERT operations. This replaces them with properly 
-- separated per-operation policies.
-- =============================================
